...
class Profile extends React.Component<any, any> {
  ...
  componentDidMount() {
    ...
    this.state.appointments.created_by =
      sessionStorage.getItem("email") || "{}";
    this.state.user.created_by = sessionStorage.getItem("email") || "{}";
  }
  GpCreate() {
    this.test.GpCreate(this.state.appointments).then(
      (data: any) => {},
      (error: any) => {
      ...
      <>
        ...
        <div id="template-iqny" className="gjs-row">
          <div id="template-ifvh" className="gjs-cell">
            <label id="template-ipmz" className="label ">
              profile
            </label>
          </div>
        ...
        <div id="template-i6qtv" className="gjs-row">
          <div id="template-i7yvx" className="gjs-cell">
            <label id="template-ikl7a" className="label ">
              user details
            </label>
          </div>
        </div>
        <div id="template-iw79g" className="gjs-row">
          <div id="template-ipuaf" className="gjs-cell">
            <label id="template-igibm" className="label ">
              User name
            </label>
            <input
              id="template-ir9zi"
              ...
              name="username"
              value={this.state.appointments.username}
              className="input form-control "
            />
          </div>
          <div id="template-i54ea" className="gjs-cell">
            <label id="template-ifvsm" className="label ">
              email
            </label>
            <input
              id="template-ik1u5"
        ...
        <div id="template-i5fys" className="gjs-row">
          <div id="template-ibvnl" className="gjs-cell">
            <label id="template-ilj5k" className="label ">
              firstname
            </label>
            <input
              id="template-ihxzk"
          ...
          <div id="template-ikuph" className="gjs-cell">
            <label id="template-ijtc1" className="label ">
              lastname
            </label>
            <input
              id="template-iqpy3"
          ...
          <div id="template-iw3ea" className="gjs-cell">
            <label id="template-isnsr" className="label ">
              mobilenumber
            </label>
            <input
              id="template-is78i"
              onChange={this.handlechange}
              name="mobile"
              value={this.state.appointments.mobile}
              className="input form-control "
            />
          </div>
        </div>
        <div id="template-ijhgi" className="gjs-row">
          <div id="template-iob6l" className="gjs-cell">
            <label id="template-i91cg" className="label ">
              street
            </label>
            <input
              id="template-issnu"
          ...
          <div id="template-i7j3r" className="gjs-cell">
            <label id="template-i5f3v" className="label ">
              city
          ...
          <div id="template-igozk" className="gjs-cell">
            <label id="template-ic25y" className="label ">
              postcode
            </label>
            <input
              id="template-ijed2"
              onChange={this.handlechange}
              name="postcode"
              value={this.state.appointments.postcode}
              className="input form-control "
            />
          </div>
        </div>
