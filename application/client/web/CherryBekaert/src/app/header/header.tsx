...
const Header = () => {
  ...
  useEffect(() => {
    ...
    setUserName(sessionStorage.getItem("Name") || null);
    setImages(sessionStorage.getItem("Image") || null);
    setCheck(sessionStorage.getItem("JwtToken"));
  });
          ...
          <div id="ighf" className="gdp-row gpd-grid sticky">
              ...
              <div id="ij0o8m" className="gdp-row gpd-grid">
                <span onClick={openNav} id="template-i2uji">
                  <div id="i8h3sg" className="cell gpd-clm">
                    <img
                      id="igjp1x"
                      src="https://cdn.grapedrop.com/uf9ef8595751c4d1f87c91168f5d51a8c/8762113d99a84fa5baf2345306d4f0c3_hamburger3.png"
                    />
                  </div>
                </span>
                <div id="ip9j7w" className="cell gpd-clm">
                  <img
                    id="i4dr2"
                    src="https://cdn.grapedrop.com/uf9ef8595751c4d1f87c91168f5d51a8c/dad97ef59d704ea0b66e4e5416c67f0a_new_logo_gep.png"
                  />
                </div>
              </div>
            </div>
            <div id="ilhu9k" className="cell gpd-clm">
              <div id="iw7pyc" className="gpd-text">
                <div id="template-i02d">{UserName}</div>
              </div>
              <label
                htmlFor="fileInput"
                id="template-iupy"
            ...
            <div id="mySidenav" className="sidenav">
              ...
              >
                <div id="ibuiwl" className="cell gpd-clm">
                  <img
                    id="imvflv"
                    src="https://cdn.grapedrop.com/uf9ef8595751c4d1f87c91168f5d51a8c/cdca723990474ba9ba33337d35ef399d_close.png"
                  />
                </div>
              </a>
              <div id="MainMenu">
                <div id="i0xya-2" className="cell gpd-clm">
                  <div id="i60c7-2" className="gdp-row gpd-grid">
                      ...
                      <div id="icrvgp" className="cell gpd-clm">
                        <div id="i6vd27" className="gdp-row gpd-grid">
                          ...
                          <div id="iytw4t" className="cell gpd-clm">
                            <a id="i9imej" className="gpd-text" href="/home">
                              home
                            </a>
                          </div>
                        </div>
                    ...
                    {check === "Admin" ? (
                      <div id="icrvgp" className="cell gpd-clm">
                        <div id="i6vd27" className="gdp-row gpd-grid">
                          ...
                          <div id="iytw4t" className="cell gpd-clm">
                            <a id="i9imej" className="gpd-text" href="/admin">
                              admin
                            </a>
                          </div>
                        </div>
                      ...
                      <div id="icrvgp" className="cell gpd-clm">
                        <div id="i6vd27" className="gdp-row gpd-grid">
                          ...
                          <div id="iytw4t" className="cell gpd-clm">
                            ...
                            >
                              appointments <i className="fa fa-caret-down"></i>
                            </a>
                          </div>
                        </div>
                      </div>
                    ...
                    {!check ? (
                      <div className="collapse" id="appointments">
                        <div id="icrvgp" className="cell gpd-clm">
                          <div id="i6vd27" className="gdp-row gpd-grid">
                            <div id="iytw4t" className="cell gpd-clm">
                              <a
                        ...
                        <div id="i6vd27" className="gdp-row gpd-grid">
                          ...
                          <div id="iytw4t" className="cell gpd-clm">
                            <a
                              ...
                              data-parent="#MainMenu"
                            >
                              notification <i className="fa fa-caret-down"></i>
                            </a>
                          </div>
                        </div>
                      </div>
                        ...
                        <div id="i6vd27" className="gdp-row gpd-grid">
                          ...
                          <div id="iytw4t" className="cell gpd-clm">
                            <a
                              ...
                              data-parent="#MainMenu"
                            >
                              provider <i className="fa fa-caret-down"></i>
                            </a>
                          </div>
                        </div>
                      </div>
                    ...
                    {check ? (
                      <div className="collapse" id="provider">
                        <div id="icrvgp" className="cell gpd-clm">
                          <div id="i6vd27" className="gdp-row gpd-grid">
                            <div id="iytw4t" className="cell gpd-clm">
                              <a
                        ...
                        <div id="i6vd27" className="gdp-row gpd-grid">
                          ...
                          <div id="iytw4t" className="cell gpd-clm">
                            <a
                              ...
                              data-parent="#MainMenu"
                            >
                              works <i className="fa fa-caret-down"></i>
                            </a>
                          </div>
                        </div>
                      </div>
                    ...
                    {check ? (
                      <div className="collapse" id="works">
                        <div id="icrvgp" className="cell gpd-clm">
                          <div id="i6vd27" className="gdp-row gpd-grid">
                            <div id="iytw4t" className="cell gpd-clm">
                              <a id="i9imej" className="gpd-text" href="/work">
                                work
                              </a>
                            </div>
                          </div>
                        ...
                        <div id="i6vd27" className="gdp-row gpd-grid">
                          ...
                          <div id="iytw4t" className="cell gpd-clm">
                            <a
                              ...
                              data-parent="#MainMenu"
                            >
                              exchange <i className="fa fa-caret-down"></i>
                            </a>
                          </div>
                        </div>
                      </div>
                    ...
                    {check ? (
                      <div className="collapse" id="exchange">
                        <div id="icrvgp" className="cell gpd-clm">
                          <div id="i6vd27" className="gdp-row gpd-grid">
                            <div id="iytw4t" className="cell gpd-clm">
                              <a
                    ...
                    <li>
                      <div id="icrvgp" className="cell gpd-clm">
                        <div id="i6vd27" className="gdp-row gpd-grid">
                          ...
                          <div id="iytw4t" className="cell gpd-clm">
                            <a id="i9imej" className="gpd-text" href="/login">
                              login
                            </a>
                          </div>
                        </div>
