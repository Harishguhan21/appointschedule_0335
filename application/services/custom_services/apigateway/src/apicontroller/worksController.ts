...
export class worksController implements Controller {
    ...
    private initializeRoutes() {
        this.router.delete('/works/:id', this.GpDelete);
this.router.get('/works/get/search', this.GpSearch);
this.router.put('/works/get/update', this.GpSearchForUpdate);
this.router.put('/works', this.GpUpdate);
this.router.get('/works/:id', this.GpGetEntityById);
this.router.get('/works', this.GpGetAllValues);
this.router.post('/works', this.GpCreate);
this.router.get('/works/userid/created_by', this.GpGetNounCreatedBy);
        //#@gepdelimeterone@#
        //#@ssofacebookapiroute@#
        //#@ssogithubapiroute@#
        //#@gepbankingapiroute@#
...
public GpDelete(req: Request, res: Response) {
        ...
        new ApiAdapter().delete(Constant.WORKSURL + `${req.url}` )
...
public GpSearch(req: Request, res: Response) {
        ...
        new ApiAdapter().get(Constant.WORKSURL + `${req.url}` )
        .then((res: any) => res.response.json()).then(result => {
            switch(req.baseUrl) { case '/mobile': res.send(result); break; case '/web': res.send(result); break; default: res.send(null); }
...
public GpSearchForUpdate(req: Request, res: Response) {
        ...
        new ApiAdapter().put(Constant.WORKSURL + `${req.url}` , req.body)
        .then((res: any) => res.response.json()).then(result => {
            switch(req.baseUrl) { case '/mobile': res.send(result); break; case '/web': res.send(result); break; default: res.send(null); }
...
public GpCreate(req: Request, res: Response) {
        ...
        new ApiAdapter().post(Constant.WORKSURL + `${req.url}` , req.body)
        .then((res: any) => res.response.json()).then(result => {
            switch(req.baseUrl) { case '/mobile': res.send(result); break; case '/web': res.send(result); break; default: res.send(null); }
