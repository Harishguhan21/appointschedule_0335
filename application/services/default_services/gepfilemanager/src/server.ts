...
class App {
    ...
    private DatabaseCredentials() {
        ...
        SCMconfig.SCMData( async result => {
            this.DB_Url = result.data.DB_URL_appointschedule_0335;
            let db_auth = result.data.DB_AUTH_appointschedule_0335;
            let db_coll = result.data.DB_COLL_appointschedule_0335;
